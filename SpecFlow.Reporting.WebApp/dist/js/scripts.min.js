...
(function() {
    "use strict";
    angular.module("app").controller("DashboardController", [ "$scope", "$routeParams", "state", function($scope, $routeParams, state) {
...
angular.module("app").run([ "$templateCache", function($templateCache) {
    "use strict";
    $templateCache.put("directives/result-badge.tpl.html", "<span class=\"label pull-right\" ng-class=\"{ 'label-success': result == 'OK', 'label-danger': result == 'Error', 'label-warning': result == 'Pending', 'label-default': result == 'NotRun' }\">{{result}}</span>");
